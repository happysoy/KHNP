...
import ArrowUpIcon from '../../../../../../public/img/ArrowUp';
import ArrowDownIcon from '../../../../../../public/img/ArrowDown';
import ArrowLeftIcon from '../../../../../../public/img/ArrowLeft';
import ArrowRightIcon from '../../../../../../public/img/ArrowRight';
import TrashIcon from '../../../../../../public/img/Trash';
import TextIcon from '../../../../../../public/img/Text';
import MultiIcon from '../../../../../../public/img/Multi';
import HashIcon from '../../../../../../public/img/Hash';
                    ...
                    >
                      {types.map((type, index) => (
                        <button key={index} className="sort-button" onClick={type.onClick}>
                          <span key={index} className="svg-icon svg-text icon-margin">
                            {type.icon}
                          </span>
                          {type.label}
                        </button>
